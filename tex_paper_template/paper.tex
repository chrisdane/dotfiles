...
Fig. \ref{fig:a} is latex' built-in example A-figure by \citet{einstein}. This is common knowledge \cite{einstein}.
...
Here is a reference to appendix Fig. \ref{fig:appendix1} in the same document, whereas Fig. \ref{supp:fig:supp:a} is in another document, the supplement!

\subsection{This is a section title containing symbols: \texorpdfstring{$\delta^{18}$}{d}O}
...
\bibliography{paper_refs} % also creates the section header ``References''
